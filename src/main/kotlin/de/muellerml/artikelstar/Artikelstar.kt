...
data class Credentials(val username: String, val password: String, val url: String = "https://artikelstar.prod.nb-data.io", val authUrl: String = "https://service.prod.nb-data.io", val cityId: String = "91f42d33-97ff-48a0-8b54-9bddc1ebcd76", val category: String = "b568f407-801e-4da6-9a21-a5267716d669")
